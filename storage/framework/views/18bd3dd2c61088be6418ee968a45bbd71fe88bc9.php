<?php $__env->startSection('content'); ?>
            ...
            <div class="card-datatable table-responsive" id="">
                <table class="table" id="summary-table">
                    ...
                    <?php $__currentLoopData = $userseedlist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <?php echo csrf_field(); ?>
                            <td><?php echo e(App\Http\Controllers\SeedController::getSeedName($value)); ?></td>
                            <td>
                                <?php echo Form::text('density', $value->density, ["class" => "form-control", "id"=>"density-".$value->user_seed_id.""]); ?>
                            ...
                            <td>
                                <?php echo Form::select('seeds_measurement',['OUNCES'=>'OUNCES','GRAMS'=>'GRAMS','ML'=>'ML', 'POUNDS'=>'POUNDS', 'KILOS'=>'KILOS'] ,(isset($value->seeds_measurement) && $value->seeds_measurement != '' ) ? $value->seeds_measurement : '', ['class' => 'form-control',"id"=>"seeds_measurement-".$value->user_seed_id.""]); ?>


                            </td>

                            <td>
                                <?php echo Form::text('maturity', $value->maturity, ['class' => 'form-control', "id"=>"maturity-".$value->user_seed_id.""]); ?>
                            ...
                            <td>
                                <?php echo Form::text('yield', $value->yield, ['class' => 'form-control', "id"=>"yield-".$value->user_seed_id.""]); ?>
                            ...
                            <td>
                                <?php echo Form::select('measurement',['OUNCES'=>'OUNCES','GRAMS'=>'GRAMS','ML'=>'ML', 'POUNDS'=>'POUNDS', 'KILOS'=>'KILOS'] ,(isset($value->measurement) && $value->measurement != '' ) ? $value->measurement : '', ['class' => 'form-control',"id"=>"measurement-".$value->user_seed_id.""]); ?>
                            ...
                            <script type="text/javascript" language="javascript">
                                $(document).ready(function () {
                                    ...
                                    $("#deleteAll_<?php echo e($value->user_seed_id); ?>").click(function (event) {

                                        $.post(
                                            "/seed/summary-delete-all",
                                            {
                                                _token: '<?php echo e(csrf_token()); ?>',
                                                user_seed_id: '<?php echo e($value->user_seed_id); ?>'
                                            },
                                            function (data) {
                                    ...
                                    $("#update_<?php echo e($value->user_seed_id); ?>").click(function (event) {
                                        ...
                                        $.post(
                                            "/seed/summary-update",
                                            {
                                                ...
                                                density: $("#density-<?php echo e($value->user_seed_id); ?>").val(),
                                                maturity: $("#maturity-<?php echo e($value->user_seed_id); ?>").val(),
                                                yield: $("#yield-<?php echo e($value->user_seed_id); ?>").val(),
                                                measurement: $("#measurement-<?php echo e($value->user_seed_id); ?>").val(),
                                                seeds_measurement: $("#seeds_measurement-<?php echo e($value->user_seed_id); ?>").val(),
                                                user_seed_id: '<?php echo e($value->user_seed_id); ?>'
                                            },
                                            function (data) {
    ...
    <?php $__currentLoopData = $userseedlist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="modal fade" id="view-modal-<?php echo e($value->user_seed_id); ?>" tabindex="-1" role="dialog"
             aria-labelledby="exampleModalLongTitle" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle"><?php echo e(App\Http\Controllers\SeedController::getSeedName($value)); ?></h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form action="/seed/detail/<?php echo e($value->user_seed_id); ?>" method="post" name="<?php echo e($value->user_seed_id); ?>">
                            ...
                            <input type="hidden" name="seed_name" id="seed_name"
                                   value="<?php echo e($value->seed_name); ?>">
