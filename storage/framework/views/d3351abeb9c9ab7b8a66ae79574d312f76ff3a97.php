        ...
        <div v-cloak class="flex min-h-screen">
            ...
            <div class="min-h-screen flex-none pt-header min-h-screen w-sidebar bg-grad-sidebar px-6">
                <a href="<?php echo e(Nova::path()); ?>">
                    <div class="absolute pin-t pin-l pin-r bg-logo flex items-center w-sidebar h-header px-6 text-white">
                       <?php echo $__env->make('nova::partials.logo', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div>
                </a>
            ...
            <div class="content">
                <div class="flex items-center relative shadow h-header bg-white z-20 px-6">
                    <a href="<?php echo e(Config::get('nova.url')); ?>" class="no-underline dim font-bold text-90 mr-6">
                    ...
                    <dropdown class="ml-auto h-9 flex items-center dropdown-right">
                        <?php echo $__env->make('nova::partials.user', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </dropdown>
                </div>
