<?php if(count(Nova::availableResources(request()))): ?>
    ...
    <?php $__currentLoopData = Nova::groupedResources(request()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group => $resources): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if(count($resources) > 0): ?>
            <?php if(count(Nova::groups(request())) > 1): ?>
                <h4 class="ml-8 mb-4 text-xs text-white-50% uppercase tracking-wide"><?php echo e($group); ?></h4>
            <?php endif; ?>

            <ul class="list-reset mb-8">
                <?php $__currentLoopData = $resources; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resource): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(! $resource::$displayInNavigation): ?>
                        <?php continue; ?>
                    <?php endif; ?>
