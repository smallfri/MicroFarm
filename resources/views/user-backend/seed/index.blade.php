                                            ...
                                            <div class="scrollbar-y">
                                                <div class="tabbable">
                                                    <ul class="nav nav-tabs nav-tabs-solid nav-justified">                                                      
                                                        ...
                                                        <li class="{{ $key == 0 ? 'active' : '' }}" id="li_{{$value->userseedname[0]->id}}"><a href="{{url('seed/edit/'.$value->userseedname[0]->id)}}" aria-expanded="true">{{$value->userseedname[0]->name}}</a></li>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <form action="#" method="post">
                                                   ...
                                                   <div class="col-md-12 pt-10 pb-10">
                                                    ...
                                                    @if($note->seed_id == $userseedlist[0]->user_seed_id)
                                                    <div class="col-md-12">
                                                            <div class="comment">
                                                                <div class="row">
                                                                    <div class="col-md-12">
